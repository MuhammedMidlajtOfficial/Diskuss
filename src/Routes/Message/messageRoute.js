...
const { uploadChannelFields, uploadChannelVideo } = require("../../Middleware/multerConfig")
...
router.post("/sendAdminMessage", uploadChannelFields, messageController.sendAdminMessage); // This should handle POST requests
